...
$bb_cfg['tp_version'] = '2.4.0.8-beta6';
$bb_cfg['tp_release_date'] = '03-01-23';
...
$bb_cfg['sphinx'] = [
  'host' => '127.0.0.1',
  'port' => 3312,
  'path' => '../install/sphinx/sphinx.conf', // path to config file on server
  'connect_timeout' => 5, // seconds
  'limits' => [
    'offset' => 0,
    'limit' => 250, // max results
  ],
];
...
$bb_cfg['attach'] = [
  ...
  'max_size' => 8 * 1024 * 1024, // максимальный размер файла в байтах
];
...
$bb_cfg['avatars'] = [
  ...
  'max_size' => 500 * 1024, // размер аватары в байтах
