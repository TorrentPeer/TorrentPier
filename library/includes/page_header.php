...
$template->assign_vars([
  ...
  'THIS_AVATAR' => \TorrentPier\Legacy\Avatar::getAvatar(false, $userdata['user_id'], $userdata['avatar_ext_id'], !bf($userdata['user_opt'], 'user_opt', 'dis_avatar')),
  ...
  'U_INVITES' => $bb_cfg['new_user_reg_only_by_invite'] ? 'invite.php' : '',
  ...
  'U_WATCHED_TOPICS' => "profile.php?mode=watch&amp;uid={$userdata['user_id']}",
]);
