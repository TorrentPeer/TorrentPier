...
\TorrentPier\Legacy\Filesystem::file_write($data['guest'], AJAX_HTML_DIR . '/jumpbox_guest.html', false, true, true);
\TorrentPier\Legacy\Filesystem::file_write($data['user'], AJAX_HTML_DIR . '/jumpbox_user.html', false, true, true);
