...
$template->assign_vars([
  ...
  'REPUTATION' => $profiledata['user_reputation'],
  'REPUTATION_ON' => $bb_cfg['reputation']['disabled'] ? false : true,
  'REPUTATION_COLOR' => ($profiledata['user_reputation'] < 0) ? 'red' : 'green',
  ...
  'USER_BIRTHDAY_ICON' => user_birthday_icon($profiledata['user_birthday'], $profiledata['user_id']),
  ...
  'U_WATCHED_TOPICS_PROFILE' => "profile.php?mode=watch&amp;uid={$profiledata['user_id']}",

  'AVATAR_IMG' => \TorrentPier\Legacy\Avatar::getAvatar(false, $profiledata['user_id'], $profiledata['avatar_ext_id'], !bf($profiledata['user_opt'], 'user_opt', 'dis_avatar')),
