...
function send_file_to_browser($attachment, $upload_dir)
{
  ...
  if (@!file_exists(@\TorrentPier\Legacy\AttachMod\Attach::amod_realpath($filename))) {
  ...
  $real_filename = \TorrentPier\Legacy\Filesystem::clean_filename(basename($attachment['real_filename']));
...
//
$rows = \TorrentPier\Legacy\AttachMod\Attach::get_extension_informations();
$num_rows = count($rows);
