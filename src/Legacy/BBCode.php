...
class BBCode
{
  ...
  private function init_replacements(): void
  {
    ...
    $mp4_exp = '(https?:)?//[^\s\?&;=\#\"<>]+?\.(mp4)([a-z0-9/?&%;][^\[\]]*)?';
    $mp3_exp = '(https?:)?//[^\s\?&;=\#\"<>]+?\.(mp3)([a-z0-9/?&%;][^\[\]]*)?';
    ...
    $this->preg = [
      ...
      '#\[acronym="(.+?)"\]#isu' => $tpl['acronym_title_open'],
      ...
      "#\[thumbnail\]($img_exp)\[/thumbnail\]\s*#i" => $tpl['thumbnail'],
      "#\[img\]($img_exp)\[/img\]#isu" => $tpl['img'],
      "#\[mp3\]($mp3_exp)\[/mp3\]#isu" => $tpl['mp3'],
      "#\[mp4\]($mp4_exp)\[/mp4\]#isu" => $tpl['mp4'],
      ...
      '#\[nfo\](.*?)\[/nfo\]#isu' => '<div class="infobox">$1</div>',
    ];
