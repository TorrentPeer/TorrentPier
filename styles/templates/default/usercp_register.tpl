...
<tr>
	<td class="prof-title">{L_EMAIL}: * <!-- IF $bb_cfg['reg_email_activation'] && not EDIT_PROFILE --><br /><h6>{L_EMAIL_EXPLAIN}</h6><!-- ENDIF --></td>
	<td><input id="email" onBlur="ajax.exec({ action: 'user_register', mode: 'check_email', email: $('#email').val()}); return false;" placeholder="{L_HOLDER_ENTER_EMAIL}" type="text" name="user_email" size="35" maxlength="40" value="{USER_EMAIL}" <!-- IF EDIT_PROFILE --><!-- IF !$bb_cfg['emailer']['enabled'] -->readonly="readonly" style="color: gray;"<!-- ENDIF --><!-- ENDIF --> />
...
<tr>
  ...
  <td><input type="text" name="user_telegram" size="30" maxlength="15" value="{USER_TELEGRAM}" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input type="text" name="user_prov" size="50" maxlength="100" value="{USER_PROV}"/></td>
</tr>
<!-- ENDIF -->
	...
	<td colspan="2">
		...
		<tr>
			...
			<td class="tCenter nowrap">
				...
				<p><label><input type="checkbox" name="delete_avatar" /> {L_AVATAR_DELETE}</label></p>
			</td>
		</tr>
		</table>
	</td>
