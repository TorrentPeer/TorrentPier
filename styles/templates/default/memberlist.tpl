...
<table width="100%">
	...
	<tr>
		<td align="right" nowrap="nowrap">
			<span class="genmed">
				<input placeholder="{L_HOLDER_ENTER_USERNAME}" type="text" class="post" name="username" maxlength="25" size="25" tabindex="1" value="{S_USERNAME}" />&nbsp;<input type="submit" name="submituser" value="{L_FIND_USERNAME}" class="mainoption" />
			</span>
		</td>
	</tr>
 	<tr>
...
<tr>
  ...
  <th class="{sorter: false}" ><b class="tbs-text">{L_STATUS}</b></th>
...
<tr class="{memberrow.ROW_CLASS} tCenter">
  ...
  <td><div>{memberrow.USER_AVATAR}</div><b>{memberrow.USER}</b></td>
	<td>{memberrow.PM}</td>
  <td>{memberrow.USER_STATUS}</td>
