...
$(document).ready(function () {
  let title_marquee = document.title + " " + "{$bb_cfg['scrolling_title']['separator']}" + " ";
  setInterval(function () {
    title_marquee = title_marquee.substring(1) + title_marquee.charAt(0);
    document.title = title_marquee;
  }, {$bb_cfg['scrolling_title']['speed']});
});
</script>
<!-- ENDIF -->
...
var cookieSecure = "{$bb_cfg['server_secure']}";
...
<!-- IF $bb_cfg['pm_dynamic']['enabled'] && LOGGED_IN -->
<script type="text/javascript">
...
<div id="logo">
  <!-- IF LOGO -->
	<a href="{U_INDEX}"><img src="{LOGO}" width="{LOGO_WIDTH}" height="{LOGO_HEIGHT}" alt="{SITENAME}" /></a>
  <!-- ELSE -->
  <h2>{SITENAME}</h2>
  <!-- ENDIF -->
  <div class="floatR">
