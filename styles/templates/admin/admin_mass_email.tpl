...
<tr>
	...
	<td class="row2"><input type="text" placeholder="{L_SORT_TOPIC_TITLE}" name="subject" size="45" maxlength="100" style="width:98%" tabindex="2" class="post" value="{SUBJECT}" /></td>
</tr>
<tr>
...
<tr>
	<td class="catBottom" colspan="2"><input type="reset" value="{L_RESET}" class="liteoption" />&nbsp;&nbsp;<input type="submit" value="{L_SEND_EMAIL}" name="submit" class="mainoption" /></td>
</tr>
</table>
