...
<table class="forumline">
	...
	<tr>
		<td class="catBottom" colspan="2">{S_HIDDEN_FIELDS} <input type="reset" value="{L_RESET}" class="liteoption" />&nbsp;&nbsp;<input type="submit" name="save" value="{L_SUBMIT}" class="mainoption" /></td>
	</tr>
</table></form>
