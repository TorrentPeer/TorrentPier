...
<tr>
  <td><h4>{L_LOGO_PATH}</h4><h6>{L_LOGO_PATH_EXPLAIN}</h6></td>
  <td><input class="post" type="text" size="20" maxlength="255" name="logo_image_path" value="{LOGO_PATH}" /></td>
</tr>
<tr>
  <td><h4>{L_LOGO_DIMENSIONS}</h4><h6>{L_LOGO_DIMENSIONS_EXPLAIN}</h6></td>
  <td><input class="post" type="text" size="3" maxlength="4" name="logo_image_h" value="{LOGO_HEIGHT}" />&nbsp;x&nbsp;<input class="post" type="text" size="3" maxlength="4" name="logo_image_w" value="{LOGO_WIDTH}"></td>
</tr>
<tr>
  <td><h4>{L_LOGO}</h4></td>
...
<tr class="row3 med">
  <td class="bold tCenter" colspan="2">{L_SEED_BONUS} <b class="warnColor1">({L_SEED_BONUS_WARNING})</b></td>
</tr>
<tr>
